...
## Auteurs du squelette du projet
- <federico.ulliana@inria.fr>
- Guillaume Pérution-Khili

## Auteurs des classes des paquets qengine.concurrent
- Mehdi Bakhtar
- Théo Foutel-Rodier
(présentes ici à titre de comparaison des performances des implémentations)
...
2. **Évaluation des requêtes en étoile** : code + rapport (3 pages) - **29 Novembre**.  Ce rapport doit impérativement inclure votre polytique d'utilisation des IA.
...
5. **Document final** (10 pages + code) : **22 décembre** . Ce rapport doit impérativement inclure votre polytique d'utilisation des IA.
...
- Déclaration et respect de la polytique d'utilisation des IA.
